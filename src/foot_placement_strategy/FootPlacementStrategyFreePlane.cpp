...
namespace loco {
  ...
  Position FootPlacementStrategyFreePlane::getCurrentFootPositionFromPredictedFootHoldLocationInWorldFrame(double swingPhase, const Position& positionHipToFootAtLiftOffInWorldFrame, const Position& positionHipToFootAtNextTouchDownInWorldFrame, LegBase* leg) {
  ...
  double FootPlacementStrategyFreePlane::getLateralComponentOfFootStep(double phase, double initialStepOffset, double stepGuess, LegBase* leg) {
  ...
  double FootPlacementStrategyFreePlane::getHeadingComponentOfFootStep(double phase, double initialStepOffset, double stepGuess, LegBase* leg)
  {
  ...
  bool FootPlacementStrategyFreePlane::loadHeightTrajectory(const TiXmlHandle &hTrajectory) {
    TiXmlElement* pElem;
    int iKnot;
    double t, value;
  ...
  double FootPlacementStrategyFreePlane::getHeightOfTerrainInWorldFrame(const Position& steppingLocationCSw) {
  ...
  const LegGroup& FootPlacementStrategyFreePlane::getLegs() const {
    return *legs_;
  }


  bool FootPlacementStrategyFreePlane::setToInterpolated(const FootPlacementStrategyBase& footPlacementStrategy1, const FootPlacementStrategyBase& footPlacementStrategy2, double t) {
    const FootPlacementStrategyFreePlane& footPlacement1 = static_cast<const FootPlacementStrategyFreePlane&>(footPlacementStrategy1);
    const FootPlacementStrategyFreePlane& footPlacement2 = static_cast<const FootPlacementStrategyFreePlane&>(footPlacementStrategy2);
  ...
  bool FootPlacementStrategyFreePlane::interpolateHeightTrajectory(rbf::BoundedRBF1D& interpolatedTrajectory, const rbf::BoundedRBF1D& trajectory1, const rbf::BoundedRBF1D& trajectory2, double t) {
  ...
  const Position& FootPlacementStrategyFreePlane::getPositionWorldToDesiredFootHoldInWorldFrame(LegBase* leg) const {
